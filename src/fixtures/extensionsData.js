export const extensions = [{
    ...
    ext: 'explain <strong>Apollonian and Dionysian</strong> archetypes.',
...
},
{
    ...
    ext: 'explain <strong>masculine and feminine</strong> archetypes.',
...
},
{
    ...
    ext: 'discover <strong>horizontal and vertical</strong> modes of understanding.',
...
},
{
    ...
    ext: 'explain the Jungian <strong>“collective unconscious”</strong>.',
...
},
{
    ...
    ext: 'apply the concept of <strong>enantiodromia</strong> to social, cultural, and historical forces.',
...
},
{
    ...
    ext: 'give examples of <strong>three primary archetypes:</strong>  situational, character, symbolic.',
...
{
    callout: 'dualism',
    ext: 'explain the concept of <strong>dualism.</strong> ',
...
},
{
    ...
    ext: 'differentiate rhyme: <strong>half/slant, internal, full, end.</strong> ',
