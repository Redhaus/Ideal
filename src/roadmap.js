...
// Okay. I'm not sure if that list above is radical. I hope not because I have even more radical ideas that I will merely present as aspirations with no demo. Can't demo everything because need to suggest that this task cannot be completed with our current resources. If anything doesn't make sense, let me know. In the end, we are just aiming to get the imaginations flowing. If the functions I outlined above can happen, I think that it would be some pretty impressive additions. I'll sell this thing like Donald Trump.
